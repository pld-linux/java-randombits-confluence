...
Source0:	https://maven.atlassian.com/contrib/org/randombits/confluence/confluence-support/4.3.2/confluence-support-%{version}.jar
...
%description
Classes from org.randombits.confluence java package. Also contains
org.randombits.util classes.
